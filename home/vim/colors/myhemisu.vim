" myhemisu.vim - Vim color scheme - based on hemisu
" ----------------------------------------------------------
" Author:	Noah Frederick (http://noahfrederick.com/)
" 		and Alexander Feoktistov (aleksfes@gmail.com)
" Version:	3.5
...
call s:h("Visual",       { "bg": s:middleLightBlue })
call s:h("IncSearch",    { "bg": s:faintBlue })
"call s:h("Search",       { "bg": s:faintGreen })
call s:h("Search",       { "bg": s:middleLightGreen })
...
call s:h("Todo",       { "fg": s:black, "gui": "bold", "cterm": "bold" })
